...
add wave -noupdate -color Magenta -itemcolor Magenta -label state /tb_midi_interface/i_midi_interface/i_midi_control/state
add wave -noupdate -color Magenta -itemcolor Magenta -label en_register /tb_midi_interface/i_midi_interface/i_midi_control/enable_note_register
...
add wave -noupdate -color {Lime Green} -itemcolor {Lime Green} -label temp_note_vector /tb_midi_interface/i_midi_interface/i_polyphone_out/s_temp_noteVector
add wave -noupdate -color {Lime Green} -itemcolor {Lime Green} -label temp_note /tb_midi_interface/i_midi_interface/i_polyphone_out/s_temp_note
add wave -noupdate -label s_current_on /tb_midi_interface/i_midi_interface/i_polyphone_out/s_current_on
add wave -noupdate -label s_current_noteVector -radix hexadecimal /tb_midi_interface/i_midi_interface/i_polyphone_out/s_current_noteVector
add wave -noupdate -label s_current_note -radix hexadecimal /tb_midi_interface/i_midi_interface/i_polyphone_out/s_current_note
...
add wave -noupdate -color Gold -itemcolor Gold -label {note1 out} -radix hexadecimal -childformat {{/tb_midi_interface/tb_note_1(8) -radix hexadecimal} {/tb_midi_interface/tb_note_1(7) -radix hexadecimal} {/tb_midi_interface/tb_note_1(6) -radix hexadecimal} {/tb_midi_interface/tb_note_1(5) -radix hexadecimal} {/tb_midi_interface/tb_note_1(4) -radix hexadecimal} {/tb_midi_interface/tb_note_1(3) -radix hexadecimal} {/tb_midi_interface/tb_note_1(2) -radix hexadecimal} {/tb_midi_interface/tb_note_1(1) -radix hexadecimal} {/tb_midi_interface/tb_note_1(0) -radix hexadecimal}} -subitemconfig {/tb_midi_interface/tb_note_1(8) {-color Gold -height 17 -itemcolor Gold -radix hexadecimal} /tb_midi_interface/tb_note_1(7) {-color Gold -height 17 -itemcolor Gold -radix hexadecimal} /tb_midi_interface/tb_note_1(6) {-color Gold -height 17 -itemcolor Gold -radix hexadecimal} /tb_midi_interface/tb_note_1(5) {-color Gold -height 17 -itemcolor Gold -radix hexadecimal} /tb_midi_interface/tb_note_1(4) {-color Gold -height 17 -itemcolor Gold -radix hexadecimal} /tb_midi_interface/tb_note_1(3) {-color Gold -height 17 -itemcolor Gold -radix hexadecimal} /tb_midi_interface/tb_note_1(2) {-color Gold -height 17 -itemcolor Gold -radix hexadecimal} /tb_midi_interface/tb_note_1(1) {-color Gold -height 17 -itemcolor Gold -radix hexadecimal} /tb_midi_interface/tb_note_1(0) {-color Gold -height 17 -itemcolor Gold -radix hexadecimal}} /tb_midi_interface/tb_note_1
...
update
WaveRestoreZoom {0 ns} {30767175 ns}

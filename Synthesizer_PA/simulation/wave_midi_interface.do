...
#add wave -noupdate -label s_note_valid /tb_midi_interface/i_midi_interface/i_polyphone_out/s_note_valid
...
WaveRestoreCursors {{Cursor 1} {11250389 ns} 0}
...
update
WaveRestoreZoom {5268136 ns} {22880625 ns}

...
# textbased testbench
vcom -2008 -explicit -work work ../source/std_logic_textio.vhd
...
vcom -2008 -explicit -work work ../source/Flanken_Det.vhd
...
vcom -2008 -explicit -work work ../source/tb_uart.vhd

#-------------------------------------

# run simulation
vsim -t 1ps -lib work work.tb_top_synthesizer
do wave_syntehsizer.do
run 2 ms

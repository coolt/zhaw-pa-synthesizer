...
add wave -noupdate /tb_mididecoder/dut/state
add wave -noupdate /tb_mididecoder/dut/next_state
add wave -noupdate /tb_mididecoder/dut/ch_geg
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {2180 ns} 0}
...
update
WaveRestoreZoom {1486 ns} {2665 ns}
